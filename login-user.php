...
<head>
    <meta charset="UTF-8">
    <title>AI Agent System Login</title>
    ...
    justify-content: center;
        ...
        .footer-links a:hover {
            color: var(--ai-purple);
            text-shadow: 0 0 5px rgba(179, 0, 255, 0.5);
        }
    ...
    <div class="login-container">
        <div class="ai-terminal">
            ...
            <div class="header">
                ...
                <p class="subtitle">ACCESS WITH YOUR EMAIL AND PASSWORD</p>
            </div>
            ...
            <form action="login-user.php" method="POST" autocomplete="">
                ...
                <div class="footer-links">
                    <a href="forgot-password.php"><i class="fas fa-key mr-2"></i>RECOVER AUTH</a>
                    <a href="signup-user.php"><i class="fas fa-user-plus mr-2"></i>REGISTER</a>
                </div>
            </form>
        </div>
    </div>
