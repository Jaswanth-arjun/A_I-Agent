...
<body>
   <!-- <nav class="navbar">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <!--  <a href="../Login-Signup-Form-with-Email-Verification-main/login-user.php" class="btn btn-outline-light me-2 login-btn">Login</a>
          <a href="../Login-Signup-Form-with-Email-Verification-main/signup-user.php" class="btn btn-light signup-btn">Sign Up</a>-->
        </div>
      </div>
    </div>
  </nav>
  ...
  <section class="hero" id="hero">
    <div class="container position-relative">
      ...
      <div class="mt-5">
       <!-- <img src="https://via.placeholder.com/800x400?text=AI+Agents+Dashboard" alt="AI Dashboard" class="img-fluid rounded shadow">-->
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row text-center">
        <div class="col-md-3">
          ...
          <script>let c=0,t=setInterval(()=>{counter.innerText=++c+"+";if(c>=1000)clearInterval(t)},0.0000000000000000000000000000000000000000000000000000000001)</script>

          <p class="text-muted">Active Users</p>
        </div>
        <div class="col-md-3">
          <h2 class="fw-bold text-primary" id="counter2">0</h2>
          <script>let c2=0,t2=setInterval(()=>{counter2.innerText=++c2+"+";if(c2>=50)clearInterval(t2)},20)</script>

          <p class="text-muted">AI Agents</p>
        </div>
        <div class="col-md-3">
          <h2 class="fw-bold text-primary" id="counter3">0%</h2>
          <script>let c3=0,t3=setInterval(()=>{counter3.innerText=++c3+"%";if(c3>=98)clearInterval(t3)},20)</script>

          <p class="text-muted">Satisfaction Rate</p>
        </div>
        <div class="col-md-3">
          <h2 class="fw-bold text-primary" id="counter4"></h2>
          <script>let txt="24/7",i=0,t4=setInterval(()=>{counter4.innerText+=txt[i++];if(i==txt.length)clearInterval(t4)},200)</script>
        ...
        <div class="col-md-4">
          <div class="card h-100">
            <div class="card-body text-center p-4">
              ...
              <a href="http://localhost:5000/course-agent" class="btn btn-primary mt-3 w-100">Start Learning</a>
            </div>
          </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  fanStack.addEventListener('click', function() {
    ...
    setTimeout(function() {
      // Remove .to-back, move to back, re-assign classes
...
<!-- Add these modals to your existing HTML (before the footer) -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="signupForm">
          ...
          <div class="mb-3" id="signupOtpField" style="display: none;">
            <label for="signupOtp" class="form-label">OTP</label>
            <input type="text" class="form-control" id="signupOtp" maxlength="6" required>
            <div class="form-text">Check your email for the OTP</div>
          </div>
          <button type="submit" class="btn btn-primary w-100" id="signupSubmitBtn">
            <span id="signupSubmitText">Send OTP</span>
