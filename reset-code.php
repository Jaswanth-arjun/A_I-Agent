...
<head>
    <meta charset="UTF-8">
    <title>AI Agent System - Verification</title>
    ...
    <div class="verification-container">
        <div class="ai-terminal">
            ...
            <div class="header">
                ...
                <p class="subtitle">ENTER YOUR AUTHENTICATION CODE</p>
            </div>
            ...
            <form action="reset-code.php" method="POST" autocomplete="off">
                ...
                <button type="submit" name="check-reset-otp" class="btn-verify">
                    <i class="fas fa-paper-plane mr-2"></i> VERIFY CODE
                </button>
            </form>
        </div>
    </div>
